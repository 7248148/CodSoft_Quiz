...
QUESTIONS =["1) Select the INCORRECTLY spelt word.? ",
            "2) If 2A=3B=4C, then A:B:C will be? ",
            "3) Which 3 numbers have the same answer whether they’re added or multiplied together?",
            "4) A main page of a website is _______ which acts as a gateway to the rest of the website's pages.",
...
CHOICE = [["[A] Finery","[B] Hiest","[C] Cringe","[D] Defer"],
